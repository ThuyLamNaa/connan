...
if (isset($_GET['delete'])) {
    ...
    try {
        ...
        echo "<script type='text/javascript'>
            ...
            window.location.href = 'account_employee.php'; 
            </script>";
    } catch (Exception $e) {
        echo "<script type='text/javascript'>
    ...
    <div class="main-content">
        ...
        <div class="content">
            ...
            <div class="content_title">
                <span>DANH SÁCH TÀI KHOẢN NHÂN VIÊN QUẢN LÝ</span>
            </div>
            <div class="button_create_account">
                <a class="btn btn-createaccount" href="create_account.php">Tạo tài khoản nhân viên</a>
            </div>
                            ...
                            while ($fetch_account = mysqli_fetch_assoc($select_account)) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="account_employee.php?delete=<?php echo $fetch_account['user_id'] ?> "
