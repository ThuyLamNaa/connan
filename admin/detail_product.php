...
$select_product = mysqli_query($conn, "SELECT 
                  p.seller_id, p.product_id, p.product_name, p.quantity, p.price, p.description, p.created_time,
                   p.product_image, p.warranty_period, p.place_of_purchase, p.purchase_price, p.time_used
                FROM products p
