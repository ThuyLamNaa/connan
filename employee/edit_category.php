...
if (isset($_POST['update_category'])) {
    ...
    if (mysqli_num_rows($select_category) > 0) {
        $errors['category_exists'] = "Lỗi, danh mục này đã tồn tại!";
    }
    ...
    echo "<script type='text/javascript'>
            ...
            window.location.href = 'management_category.php'; // Chuyển hướng về trang quản lý danh mục
          </script>";
    }
}
...
<head>
    ...
    <title>Chỉnh sửa danh mục sản phẩm - Nhân viên</title>
            ...
            <form method="post" class="form_information">
                <div class="form_group">
                    ...
                    <input type="text" class="form-control" name="category_name"
                        value="<?php echo $fetch_category['category_name']; ?>" maxlength="30">
                ...
                <div class="form_group">
                    ...
                    <input type="text" class="form-control" name="description"
                        value="<?php echo $fetch_category['description']; ?>" maxlength="60">
                ...
                <div class="button_create">
                    <input name="update_category" type="submit" class="btn" value="Cập nhật">
                </div>
            </form>
